...
def draw_counters(eggs, lives):
    screen.blit("egg-count", (0, HEIGHT - 30))
    screen.draw.text(str(eggs), fontsize=40, pos=(30, HEIGHT - 30), color=FONT_COLOUR)
    screen.blit("life-count", (60, HEIGHT - 30))
    screen.draw.text(str(lives), fontsize=40, pos=(90, HEIGHT - 30), color=FONT_COLOUR)
...
# Use pgzrun main.py to play! Stay safe from those dirty dragons!
